 ...
 *
 * Read-only: never publishes content or mutates deployment state.
 ...
 * @param {string} [options.publicPath] Public route path to test (default: /)
...
Options:
  ...
  --public-path <path>   Public route path to test (default: /)
  --help, -h             Show this help message
`);
      process.exit(0);
    } else {
      throw new AccessVerificationError(`Unknown or incomplete option: ${arg}`, 'cli-options');
    }
  }
