...
| Routine checks | `npm run test:cms` (172 tests, all passing at this update); `npx wrangler d1 migrations apply DB --local`; `node scripts/db/verify-staging.mjs --wrangler --local` |
